        ...
        >
          <div className="text-center">
            ...
            <button 
              ...
              className="px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 text-white rounded-md transition-colors w-full transform hover:scale-105 duration-200 shadow-lg shadow-blue-700/20"
            >
              Return to Upload
            </button>
          </div>
